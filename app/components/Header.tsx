          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="hidden sm:flex relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2 w-64 rounded-lg border border-slate-200 focus:outline-none focus:border-blue-500 text-sm bg-white/50 backdrop-blur-sm"
              />
            </div>
          ...
          <div className="md:hidden border-t border-slate-200 py-4">
            ...
            <div className="mt-4 relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 focus:outline-none focus:border-blue-500 text-sm bg-white/50 backdrop-blur-sm"
              />
            </div>
          </div>
        )}
